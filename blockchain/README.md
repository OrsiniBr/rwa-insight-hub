...
forge script script/QuestStake.s.sol:QuestStakeScript --rpc-url $MANTLE_SEPOLIA_RPC_URL --private-key $PRIVATE_KEY --broadcast --verify --etherscan-api-key $ETHERSCAN_API_KEY

forge script script/RewardScript.sol:RewardScript --rpc-url <YOUR_RPC_URL> --broadcast --verify -vvvv
